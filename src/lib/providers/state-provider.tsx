      ...
      return {
        ...
        workspaces: state.workspaces.map((workspace) => {
          if (workspace.id === action.payload.workspaceId) {
            return {
              ...workspace,
              folders: workspace.folders.map((folder: { id: string; }) => {
          ...
          if (workspace.id === action.payload.workspaceId) {
            return {
              ...
              folders: workspace.folders.filter(
                (folder: { id: string; }) => folder.id !== action.payload.folderId
              ),
            };
          }
          return workspace;
      ...
      return {
        ...
        workspaces: state.workspaces.map((workspace) => {
          if (workspace.id === action.payload.workspaceId) {
            return {
              ...workspace,
              folders: workspace.folders.map((folder: { id: string; files: any; }) => {
                if (folder.id === action.payload.folderId) {
                  return {
                    ...folder,
      ...
      return {
        ...
        workspaces: state.workspaces.map((workspace) => {
          if (workspace.id === action.payload.workspaceId) {
            return {
              ...workspace,
              folder: workspace.folders.map((folder: { id: string; files: any[]; }) => {
                if (folder.id === action.payload.folderId) {
                  return {
                    ...folder,
                    files: folder.files.filter(
                      (file: { id: string; }) => file.id !== action.payload.fileId
                    ),
                  };
                }
                return folder;
      ...
      return {
        ...
        workspaces: state.workspaces.map((workspace) => {
          if (workspace.id === action.payload.workspaceId) {
            return {
              ...workspace,
              folders: workspace.folders.map((folder: { id: string; files: { id: string; }[]; }) => {
                if (folder.id === action.payload.folderId) {
                  return {
                    ...folder,
                    files: folder.files.map((file: { id: string; }) => {
